...
function getCircuitHTML(id) {
    return `<div class="circuit-block" id="circuit-${id}" data-id="${id}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group"><label for="fatorPotencia-${id}">Fator de Potência (eficiência)</label><input type="number" id="fatorPotencia-${id}" step="0.01" value="0.92"></div>
            ...
            <div class="form-group"><label for="resistividadeSolo-${id}">Resistividade T. do Solo (C.m/W)</label><select id="resistividadeSolo-${id}"></select></div>
            <div class="form-group"><label for="numCircuitosAgrupados-${id}">N° de Circuitos Agrupados</label><select id="numCircuitosAgrupados-${id}"><option value="1" selected>1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option></select></div>
...
export function populateProjectList(projects) { /* ... Omitido por ser igual ... */ }
export function populateFormWithProjectData(project) { /* ... Omitido por ser igual ... */ }
export function populateUsersPanel(users) { /* ... Omitido por ser igual ... */ }
export function populateEditUserModal(userData) { /* ... Omitido por ser igual ... */ }
export function populateProjectsPanel(projects, clients, users, currentUserProfile) { /* ... Omitido por ser igual ... */ }
export function populateClientManagementModal(clients) { /* ... Omitido por ser igual ... */ }
export function resetClientForm() { /* ... Omitido por ser igual ... */ }
export function openEditClientForm(client) { /* ... Omitido por ser igual ... */ }
export function populateSelectClientModal(clients, isChange = false) { /* ... Omitido por ser igual ... */ }
