    ...
    return `<div class="circuit-block" id="circuit-${id}" data-id="${id}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <select id="resistividadeSolo-${id}">
